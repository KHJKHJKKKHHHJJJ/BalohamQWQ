...
class Quiz:
    def __init__(self, quiz_window, date_vocab, date, Id):
        ...
        self.Language_type = Label(self.texts_frame, text="단어", font=("", "25"), fg="black", height=1, width=10, bg=bg2)
        ...
        self.selections = []
        for i in range(3):
            btn = Button(sel_btn_frame, text=f"{i + 1}번", width= 53, height= 2, font=("", 15, 'bold'), command=self.incorrect, bg=btncol)
        ...
        #건너뛰기 or 다음 문제
        self.nextbtn = Button(quiz_window, text="건너뛰기", width= 38, height=3, font=("",15,'bold'), bg="light yellow", command=self.next_word)
